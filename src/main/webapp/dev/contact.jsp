...
<head>
    <meta charset="utf-8">
    <title>Contact - Pilgrimage</title>
        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="" class="navbar-brand">
                    <h1 class="m-0 text-primary"><span class="text-dark">PILGRIMA</span>GE</h1>
                </a>
                ...
                <div class="col-lg-8">
                    <div class="contact-form bg-white" style="padding: 30px;">
                        ...
                        <form action="contactsave" method="post">
                            ...
                            <div class="control-group">
                                <textarea class="form-control py-3 px-4" rows="5" id="message" name="messsage" placeholder="Message"
                                    required="required"
                                    data-validation-required-message="Please enter your message"></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="text-center">
                            <input type="submit" value="Send Message" class="btn btn-primary py-3 px-5" onclick="alert('Message Sent Successfully...!')">
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5" style="margin-top: 90px;">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p>website is under maintenance we'll back shortly</p>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p><i class="fa fa-map-marker-alt mr-2"></i>Vadgaon Sheri, Pune, Bharat</p>
                <p><i class="fa fa-phone-alt mr-2"></i>+91 9765817492</p>
                <p><i class="fa fa-envelope mr-2"></i>othube97@gmail.com</p>
    ...
    <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5" style="border-color: rgba(256, 256, 256, .1) !important;">
        <div class="row">
            <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white-50">Copyright &copy; <a href="#">2023</a>. All Rights Reserved.</a>
                </p>
            </div>
            <div class="col-lg-6 text-center text-md-right">
                <p class="m-0 text-white-50">Designed by <a href="https://htmlcodex.com">Pilgrimage</a>
                </p>
            </div>
        </div>
    </div>
