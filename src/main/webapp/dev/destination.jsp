...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <p><i class="fa fa-phone-alt mr-2"></i>9130591063 / 9765817492</p>
                    </div>
                </div>
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
						...
						aria-haspopup="true" aria-expanded="false"> <i
							class="far fa-user mr-2 tm-logout-icon" style="font-size: 20px"></i>
					</a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<hr> 
							<a class="dropdown-item" href="userprofile?email=${email}"
   ...
   <!-- Destination Start -->
    ...
    <div class="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5" style="margin-top: 90px;">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p>Pilgrimage is a powerful metaphor for any journey with the purpose of finding something that matters deeply to the traveler.</p>
    ...
    <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5" style="border-color: rgba(256, 256, 256, .1) !important;">
        <div class="row">
            <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white-50">Copyright &copy; <a href="https://instagram.com/localhost__8080_?igshid=MzNlNGNkZWQ4Mg==">localhost__8080_</a>. All Rights Reserved.</a>
                </p>
            </div>
            <div class="col-lg-6 text-center text-md-right">
                <p class="m-0 text-white-50">Designed by <a href="https://github.com/omkar5432">Omkar5432</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <%
    	String name =(String) s1.getAttribute("person1");
    	String email =(String) s1.getAttribute("person");
    	String gender =(String) s1.getAttribute("omkar");
    	
    	s1.setAttribute("s", name);
    	s1.setAttribute("y", email);
    	s1.setAttribute("z",gender);
    %>
</body>
