  ...
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z"/>
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav mx-auto">
								...
								<li class="nav-item"><a class="nav-link" href="showuser">Users</a>
								</li>
								...
								<li class="nav-item dropdown"><a
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown">
										<a class="dropdown-item" href="showhotel">Hotels</a> <a
											class="dropdown-item active" href="usercontact">Contact</a> <a
						...
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<h2 class="tm-block-title d-inline-block"
									style="font-family: TimesNewRoman">&bull; Users Details</h2>
							...
							<table
								...
								<thead>
									<tr class="tm-bg-gray">
										<th scope="col">&nbsp;</th>
										<th scope="col">ID</th>
										<th scope="col" class="text-center">Contact User Name</th>
								...
								<tbody>
									<c:forEach var="w" items="${c}">
										<tr>
											<td scope="col">&nbsp;</td>
											<td class="tm-product-name">${w.id}</td>
											<td class="text-center">${w.name}</td>
											<td class="text-center">${w.email}</td>
											<td class="text-center">${w.subject}</td>
											<td class="text-center">${w.messsage}</td>
											<td class="text-center"><a
												href="deletecontact?id=${w.id}" style="color: black"
												onclick="alert('Do you really want to Delete Record')">
												<span class="glyphicon" style="color: black">&#xe020;</span>&nbsp Delete
											</a></td>
										</tr>
									</c:forEach>
								</tbody>
